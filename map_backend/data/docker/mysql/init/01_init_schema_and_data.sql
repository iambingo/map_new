...
INSERT INTO `ic_mixed_questionnaire_submissions` VALUES ('2026Q2',3,'SUBMITTED','{\"bond_view\": \"偏多\", \"core_view\": \"全部梭哈！\", \"risk_flag\": false, \"equity_view\": \"偏多\", \"a_stock_view\": \"看涨\", \"focus_assets\": [\"黄金\"], \"commodity_view\": \"偏多\", \"long_rate_view\": \"看涨\", \"short_rate_view\": \"看涨\"}','2026-04-22 05:31:06',1,'2026-04-22 03:21:33','2026-04-22 05:31:05',0),('2026Q2',1,'SUBMITTED','{\"test\": 1}','2026-04-22 05:29:43',2,'2026-04-22 05:29:43','2026-04-22 05:29:43',0);
...
CREATE TABLE `map_users` (
  `portal_user_id` bigint NOT NULL COMMENT '门户用户 ID（逻辑关联，无物理外键）',
  `username` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '登录用户名',
  `display_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '显示名称/姓名',
  `email` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '邮箱',
  `department` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属部门',
  ...
  `is_deleted` smallint NOT NULL DEFAULT '0' COMMENT '软删除标志 0=正常 1=已删除',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_map_users_portal_id` (`portal_user_id`),
  UNIQUE KEY `uq_map_users_username` (`username`),
  KEY `ix_map_users_is_deleted` (`is_deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='MAP 系统用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `map_users` WRITE;
/*!40000 ALTER TABLE `map_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `map_users` ENABLE KEYS */;
UNLOCK TABLES;
