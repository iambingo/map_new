---
name: "source-command-plan-design-review"
...
# source-command-plan-design-review

Use this skill when the user asks to run the migrated source command `plan-design-review`.
