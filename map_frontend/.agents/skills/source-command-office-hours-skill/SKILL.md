---
name: "source-command-office-hours-skill"
...
# source-command-office-hours-skill

Use this skill when the user asks to run the migrated source command `office-hours-SKILL`.
