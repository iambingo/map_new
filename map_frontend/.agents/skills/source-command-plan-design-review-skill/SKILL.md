---
name: "source-command-plan-design-review-skill"
...
# source-command-plan-design-review-skill

Use this skill when the user asks to run the migrated source command `plan-design-review-SKILL`.
