---
name: "source-command-plan-ceo-review-skill"
...
# source-command-plan-ceo-review-skill

Use this skill when the user asks to run the migrated source command `plan-ceo-review-SKILL`.
